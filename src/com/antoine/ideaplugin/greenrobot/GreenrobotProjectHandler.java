...
public class GreenrobotProjectHandler extends AbstractProjectComponent {

  private static final Key<GreenrobotProjectHandler> KEY = Key.create(GreenrobotProjectHandler.class.getName());
  public static final Logger LOGGER = Logger.getInstance(GreenrobotProjectHandler.class);
  ...
  protected GreenrobotProjectHandler(Project project, PsiManager psiManager) {
    super(project);
    this.findUsagesManager =
        ((FindManagerImpl) FindManager.getInstance(project)).getFindUsagesManager();
    this.psiManager = psiManager;
    project.putUserData(KEY, this);
    //System.out.println("GreenrobotProjectHandler initialized");
  }

  public static GreenrobotProjectHandler get(Project project) {
  ...
  private void maybeAddSubscriberMethod(PsiMethod element) {
    PsiTypeElement methodParameter = GreenrobotLineMarkerProvider.getMethodParameter(element);
